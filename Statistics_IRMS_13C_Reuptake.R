...
vector_Species_Tissue <- c("0µM_TR",
                           "0µM_TS",
                           "50µM_TR",
                           "50µM_TS",
                           "500µM_TR",
...
Subsets[["0µM_TR"]][["Time"]] <- factor(Subsets[["0µM_TR"]][["Time"]])
Subsets[["0µM_TS"]][["Time"]] <- factor(Subsets[["0µM_TS"]][["Time"]])
...
#for Treatment ####
#Read CSV ####
table <- read.csv("DATA_IRMS_13C_Results.csv", sep=";",
                  header=T)
