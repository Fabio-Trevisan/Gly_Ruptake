...
SW_test <- table %>%
  ...
  shapiro_test(Value)
View(SW_test)
write.table(SW_test, file = "MassBalance_ShapiroWilk_test_results.csv", quote = FALSE, sep = ";")
...
View(TwoWay_Anova[["INSERT SPECIES_TISSUE TO VISUALIZE"]])
write.table(TwoWay_Anova, file = "MassBalance_TwoWay_Anova_results.csv", quote = FALSE, sep = ";")

sink("MassBalance_TwoWay_Anova_results2.csv")
TwoWay_Anova
sink(NULL)
...
##OneWayAnova save
sink("MassBalance_OneWayAnova_Results_Ti.csv")
OneWay_Anova_Ti2 
sink(NULL)
...
##OneWayAnova save
sink("MassBalance_OneWayAnova_Results_Tr.csv")
OneWay_Anova_Tr2 
sink(NULL)
